...
#%%
BASE_URL = "/Users/janekom/Desktop/HealthTech/NLP project python/"

#%%
#display options
pd.set_option('display.max_colwidth', None)
#%%
# Score Clinical Patient Notes: analysis
patient_notes = pd.read_csv("/Users/janekom/Desktop/HealthTech/NLP project python/patient_notes.csv")
patient_notes.head(3)
#%%
patient_notes.iloc[5000:5003, :]
#%%
# feautures info
features = pd.read_csv("/Users/janekom/Desktop/HealthTech/NLP project python/features.csv")
features.info()
...
plt.axis('off')
#%%
# Score Clinical Patient Notes : modeling

# Datasets Helper Function
# need to merge features, patient_notes with train data
...
def get_location_predictions(preds,
                             offset_mapping,
                             sequence_ids,
                             test=False):
    all_predictions = []
    for pred, offsets, seq_ids in zip(preds,
                                      offset_mapping,
                                      sequence_ids):
...
def calculate_char_cv(predictions,
                      offset_mapping,
                      sequence_ids,
                      labels):
    all_labels = []
    all_preds = []
    for preds, offsets, seq_ids, labels in zip(predictions,
                                               offset_mapping,
                                               sequence_ids,
                                               labels):
...
#%%
## TRAIN
# train the model with BCEWithLogitsLoss and AdamW as optimizer
...
### RESULTS
# Valid loss: 0.2006784667555276
# Valid score: {'Accuracy': 0.9943525480653309,
# 'precision': 0.7746326929004418,
# 'recall': 0.871769671041221,
# 'f1': 0.8203356635747899}
...
#%%
# represent accuracy, precision and recall
import pandas as pd
