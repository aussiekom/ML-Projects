...
```{r data}
housing <- read.csv("USA_Housing.csv", col.names = c("Avg.Income","Avg.House.Age", "Avg.Num.of.Rooms",  "Avg.Num.of.Bedrooms",  "Area.Population",  "Price", "Address"))

variables <- c("Avg.Income","Avg.House.Age", "Avg.Num.of.Rooms",  "Avg.Num.of.Bedrooms",  "Area.Population")
